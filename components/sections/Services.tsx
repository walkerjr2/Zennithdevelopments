        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-slate-50 dark:bg-slate-800 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300"
            >
              ...
              <button
                ...
                className="inline-flex items-center text-zd-royal-blue dark:text-zd-electric-cyan font-semibold group-hover:gap-2 transition-all duration-300"
              >
                Learn More
