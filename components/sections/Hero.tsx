    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zd-electric-cyan/10 border border-zd-electric-cyan/20 text-zd-royal-blue dark:text-zd-electric-cyan text-sm font-semibold">
              <span className="w-2 h-2 bg-zd-electric-cyan rounded-full animate-pulse"></span>
          ...
          >
            Custom web solutions that drive measurable business growth.
            <br />
            From concept to launch in{' '}
            <span className="font-semibold text-zd-royal-blue dark:text-zd-electric-cyan">
              12 weeks
            </span>
            .
          </motion.p>
          ...
          >
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-zd-electric-cyan" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold">&lt; 2hr</span>
